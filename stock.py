...
def stock_price2(stock_code, history_date=None):
    # 指定CSV檔案的路徑
    ...
    # 找到歷史日期的資料
    historical_data = df[df['Date'] == history_date]

    # Print for debugging
    print("Data for provided historical date:", historical_data)

    # 根據股票代碼進行進一步篩選
    matching_row = historical_data[historical_data['公司 代號_x'] == stock_code]
